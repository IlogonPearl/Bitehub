...
# Helper to set background using base64 (works on Streamlit Cloud)
...
# If image exists, set background; otherwise show a friendly warning.
if os.path.exists(image_path):
    set_background(image_path)
else:
    st.warning("Background image not found. Please upload can.jpg in your project folder (optional).")
...
if os.path.exists(image_path):
    ...
    try:
        ...
        st.error(f"⚠️ Could not load background: {e}")
